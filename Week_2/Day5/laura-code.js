...
function turnHoursToMinutes(moviesArray) {
    ...
    // //Comprobamos que se ha cambiado el minutaje
    // console.log("El minutaje es: " + minutesArray[0].duration);
    // console.log("El tipo de dato almacenado es: " + typeof minutesArray[0].duration)

    // //Compruebo si el array de origen es igual al array que hemos creado
    // console.log(minutesArray === moviesArray);

    //Entramos en la última parte del ejercicio
    for (let i = 0; i < minutesArray; i++)
        minutesArray[i].duration = Number(minutesArray[i].duration)

        //Muestro cada elemento por consola
